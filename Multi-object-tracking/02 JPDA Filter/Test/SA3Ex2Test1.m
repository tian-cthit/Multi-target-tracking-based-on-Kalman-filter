...
sigmaV = 1;
sigmaOmega = pi/180;      
motion_model = motionmodel.cvmodel(T,sigmaV);
...
nbirths = 4;        
K = 20;       
initial_state = repmat(struct('x',[],'P',diag([1 1 1 1].^2)),[1,nbirths]);                
initial_state(1).x = [-10; -10; 8; 0];      tbirth(1) = 1;   tdeath(1) = K;      
initial_state(2).x = [20; 20; -20; 0];    tbirth(2) = 1;   tdeath(2) = K;      
initial_state(3).x = [-20; 10; -10; 0];  tbirth(3) = 1;   tdeath(3) = K;   
initial_state(4).x = [0; 0; 5; 0];    tbirth(4) = 1;   tdeath(4) = K;
