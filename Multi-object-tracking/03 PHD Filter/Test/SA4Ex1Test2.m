...
measdata = [initial_state.x];
measdata = measdata(1:2, :);
...
PPP = update(PPP,measdata,meas_model,sensor_model.intensity_c,P_D,gating);
...
%One step update
PPP_ref = update(PPP_ref,measdata,meas_model,sensor_model.intensity_c,P_D,gating);
